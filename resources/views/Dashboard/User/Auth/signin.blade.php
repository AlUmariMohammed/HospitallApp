                                        ...
                                        <div class="card-sigin">
                                            <div class="main-signup-header">
                                                ...
                                                <div class="loginform" id="user">
                                                    ...
                                                    <h5 class="font-weight-semibold mb-4">User login Case</h5>
                                                    <form method="POST" action="{{ route('login.user') }}">
                                                        @csrf
                                                        <div class="form-group">
                                                            <label>Email</label> <input class="form-control" placeholder="Enter your email" type="email" id="email" name="email" :value="old('email')" required autofocus />
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Password</label> <input class="form-control" placeholder="Enter your password" id="password"
                                                                                           type="password"
                                                                                           name="password"
                                                ...
                                                <div class="loginform" id="admin">
                                                    ...
                                                    <h5 class="font-weight-semibold mb-4">Admin login Case</h5>
											...
											<div class="card-sigin">
												<div class="main-signup-header">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="exampleFormControlSelect1" id="sectionChooser">
                                                            <option value="" selected disabled>اختر من القائمة</option>
                                                            <option value="admin">الدخول ادمن</option>
                                                            <option value="user">الدخول كمريض</option>
                                                        </select>
